...
Reinstein; with Caviola, Fitz, Kagan
...
Some early work on this can be found at <http://innovationsinfundraising.org/doku.php?id=iifwiki:evidence_tools> and on the linked Airtable; further work is stored in a database format.
...
- Will these same tools help motivate support for foreign aid and other pro-poor policies? What is the interaction between private giving and (support for) government policies, and how can we boost the *net* effect?
...
Support from Paul Smeets (Sustainable Finance, Maastricht)

Leveraging prior work of Charity Science

Seeking support from the BITSS for meta-analysis projects, and from X-Econ.org for data sharing

Early-stage associated funding from the ESRC and the support from the CEA
