...
<div class="marginnote">
For an introduction to the field of effective altruism, see [this article](https://www.effectivealtruism.org/articles/introduction-to-effective-altruism/) from [effectivealtruism.org](https://www.effectivealtruism.org/)
</div>

<div class="marginnote">
Also see [here](https://www.effectivealtruism.org/resources/) for an introductory resource list for effective altruism, including articles on the key ideas of the movement, as well as books, podcasts and videos.
</div>
...
<div class="marginnote">
As @burumEvolutionaryExplanationIneffective2020 state:
...
*Aside: 'but what about uncertainty?*<div class="marginnote">
...
<div class="marginnote">
\* I believe this corresponds to a 'symmetric' welfare function in Economics.</div>
...
### [Barriers: Awareness, consideration, and distance distance (Physical, Psychological/Emotional, Social)](#aware-distance) {-}
...
### [Identity and signaling](#identity) {-}
