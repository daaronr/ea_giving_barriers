...
### Aside: Economic models of giving
...
It is also important to note that the 'warm glow' presented in the Economics literature does not map to a single psychological mechanism or theory, and there is some ambiguity as to which motivations should be subsumed in this. According to Andreoni (who coined the term):
