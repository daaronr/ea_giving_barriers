...
-   Taboo Tradeoffs and Protected Values: to the extent that CBA requires making taboo tradeoffs that clash with protected values, people may be reticent to engage in CBA for prosocial purposes.
...
Null's result is interesting but it is a unique, somewhat unusual, and somewhat artificial contexts. The participants were awarethat they were in an experiment.
...
#### Evidence for "People do not respond 'efficiently' to information about costs and benefits" {.unnumbered}
...
Opportunity to buy info on 'recipient type' increased giving, information on 'admin costs' decreased giving (marginal significance for both), no effect of 'aid impact' but wide CI

\

*Limitations and caveats (@metzgerMakingImpactRelevance2019)*



- 'Free information' on each of these had insignificant effects (underpowered!)

- Specificity and confounds; e.g., recipient type (artists vs children) may have been seen as a proxy for impact
...
#### [@caviola2020many] (Information treatments, debunking/debiasing) {#caviola}
...
**Summarised findings (the authors' claim) and main points**:
...
Stated finding: \> Charities are only rewarded for revealing information about their impact when the results are unrealistic and unattainable.
