...
When considering how we can reduce suffering through effective altruism, immediate problems such as hunger and poverty are clearly visible. However, as well as the people alive today, altruistic concerns should arguably consider challenges that can impact the welfare of future individuals as well. Benjamin Todd outlines this in his article on [‘longtermism’](https://80000hours.org/articles/future-generations) (worth reading for a more in-depth discussion of the issue) as follows:
...
This consideration of future people and future problems includes commonly discussed issues, such as the future of climate change, as well as more low-probability problems that may be more neglected in terms of attention from altruists, such as nuclear war, bioterrorism and AI related issues [@macaskillDoingGoodBetter2015]. Arguments for the importance of considering these problems have been made by individuals such as @ord2020precipice and institutions like the [Future of Humanity Institute](https://www.fhi.ox.ac.uk)

However, even motivating giving for current issues [presents many challenges](#present-puzzle), so encouraging giving for people who are yet to be born could prove even more difficult.
...
Considering how heavily we should weigh the future is a subject that has been raised frequently in the field of Economics (perhaps most notably climate economics in recent times), leading us to the idea of discount rates [@ackerman2008climate]. @greaves2017discounting outlines how discount rates can work as follows:
...
Beyond the technical analysis of "at what rates people might discount the future", @schubertFocusCollectiveAttention2020 also outlines a few reasons why the distant future may receive less attention and action. Firstly, he suggests that present issues are likely more salient than future issues, and because these issues are more salient, they will get discussed more. Secondly, he argues that uncertainty is likely an important factor. Even if you are concerned with future well-being, if it is unclear how you can impact the distant future, you may be more likely to focus on other issues. He also makes the case that a lack of political polarisation could mean that issues get less attention, as “When there is no political conflict, a question might get less discussed, even if it’s seen as morally important”.


<div class="marginnote">
However the uncertainty channel is not necessarily a bias. It may be a reasonable response. And if we are 'too risk-averse' in our other-regarding choices, that is a bias but it is not a bias of 'distance'... it merits its own category.  (This is something we aim to discuss under quantitative biases, ['excessive risk aversion'](#risk_a).)

 </div>

Beyond the technical analysis of at what rates people might discount the future, @schubertFocusCollectiveAttention2020 also outlines a few reasons why the distant future may receive less attention and action. Firstly, he suggests that present issues are likely more salient than future issues, and because these issues are more salient, they will get discussed more.

Secondly, he argues that uncertainty is likely an important factor. Even if you are concerned with future well-being, if it is unclear how you can impact the distant future, you may be more likely to focus on other issues. While uncertainty could pose a problem for encouraging giving for distant future causes in particular, factoring in uncertainty is not necessarily a bias. It may be a reasonable choice, and there is further discussion of uncertainty and how this may link to risk aversion [(see here)](#other-possibilities).

Additionally, he makes the case that a lack of political polarisation could mean that issues get less attention, as “When there is no political conflict, a question might get less discussed, even if it’s seen as morally important”.

We can also point to the other barriers to effective giving in this section, and link these to a potential lack of future-focused giving. For example, when it comes to the [availability bias](#availability), we suggested that vividness and salience of events may influence how people estimate probabilities. Future events may be hard to picture, particularly more abstract risks like the [dangers of artificial intelligence](https://futureoflife.org/background/benefits-risks-of-artificial-intelligence/)

We also discussed the [identifiable victim effect](#statvictim). It could be significantly harder to create a story around a single victim if victims affected by that issue do not yet exist. Victims of the distant future may have to be statistical victims only, potentially eliciting less sympathy and consequently less donations. Charities that focus on the distant future may also have issues demonstrating evidence of their impact to donors, which can help to encourage donations ([@karlanEffectEffectivenessDonor2017]. However, the influence of demonstrating impact is mixed, discussed more [here](#eval-aversion)
...
It is possible that distant-future generations could be put in their own category, considered separately from near-future and present generations, and their distance could mean that people identify with them less. If distant-future generations *are* seen as an out-group, this could pose a barrier for giving to distant future generations. Whether those in the future do in fact form an out-group could be a direction for further research in this area.
