...
Typically, the most effective (humanitarian) charitable contributions will go from wealthy countries in the "North"  to poor countries in the "South".<sup>Citation/cross-reference needed.</sup>  The large, social,  cultural geographic distance may be an important barrier to giving  and a reason why people prefer to give locally. However, technology continues to reduce these barriers (see, e.g., Give Directly and their new web-enabled tools).<sup>needs more specific citation </sup>
...
There is some evidence for this in charitable contexts. @chenGroupIdentitySocial2009 found that when matched with an in-group member <sup>[in a lab experiment?]</sup>, people were significantly more likely to show charitable concern.<sup>['show charitable concern' in what way?]</sup>  @Sudhir2016a suggest that categorizing others as in-group members (along lines such as race, gender and age) increases the sense of responsibility and level of emotion felt, resulting in higher levels of sympathy and consequently a stronger urge to help. They examined this effect by randomising advertising content. <sup> In a large scale field experiment with a charitable mailing in India...?</sup> When the woman on a flyer advertising the charity in question was from the in-group (in this case a Hindu woman in India, compared to a Christian woman in the out-group), they found a higher rate of donation and greater amounts raised.<sup>Give some statistics here.</sup>


The in-group/out-group may have important implications for effective giving: donors from wealthy countries may find more 'in-group' members closer to home, thus neglecting causes that benefit 'out-group' members from other countries and cultures [@baron2011heuristics].
<!-- DR: Not sure we need this paragraph as we said it above. But what exactly is being referenced here from Baron? -->
...
@epsteinCrisisMentalitySSIR2006 concluded <sup>[based on what analysis/evidence?]</sup> that natural disasters received a level of donations that was significantly out of proportion to the damage the disasters caused, while other long-term, persistent problems such as AIDS and malaria got much less attention, and consequently much less funding. [He argued that] The huge donations to causes like Hurricane Katrina also had the effect of significantly reducing donations to some other charities. 
<div class="marginnote">
This is controversial and hard to measure. The issue of 'expenditure substitution' is still largely unresolved. See previous section (['Are characteristic in competition](#substitution)).
</div>
