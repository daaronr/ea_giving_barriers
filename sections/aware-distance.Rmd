...
However, even motivating giving for current issues presents many challenges, so encouraging giving for people who are yet to be born could prove even more difficult. 
...
We can also point to the other barriers to effective giving in this section, and link these to a potential lack of future-focused giving. For example, when it comes to the availability bias, we suggested that vividness and salience of events may influence how people estimate probabilities. Future events may be hard to picture, particularly more abstract risks like the [dangers of artificial intelligence](https://futureoflife.org/background/benefits-risks-of-artificial-intelligence/)

We also discussed the identifiable victim effect. It could be significantly harder to create a story around a single victim if victims effected by that issue do not yet exist. Victims of the distant future may have to be statistical victims only, potentially eliciting less sympathy and consequently less donations. Charities that focus on the distant future may also have issues demonstrating evidence of their impact to donors, which can help to encourage donations ([@karlanEffectEffectivenessDonor2017]. 

The impact of people being categorised into in-groups and out-groups in influencing donations could also be considered. If people do give more to in-groups, such as those of the same race, gender and age ([@Sudhir2016a]), then the time in which people live could be seen as one of these categories, with those in the distant future potentially forming an out-group.
