...
- Depending on your RStudio settings, it may put up a 'preview version' of the site
...
- Once you commit and push, the 'new' bookdown website should be up
...
We had a  [see the tutorial on using the Airtable and Innovationsinfundraising.org here](https://github.com/daaronr/ea_giving_barriers/blob/master/documentatiion_and_tutorials/project_airtableexplained/airtable_database_overview.pdf)
