...
4.  R-Studio  'Addins (see bar at top)', (Citr) 'insert citation', settings (brings up the screen shown above)

- Make sure 'add references to' specifies the  "...`ea_giving_barriers/support/reinstein_bibtex.bib`" folder. 

-  Make sure Zotero 'reinstein_research_and_impact_collabs' library is loaded

5. Try to add the citation/reference. 

- Note that `[@reference]` gives a different format than `@reference` (see below test).
...
From Reinstein_references.bib

[@fongTruthGivingExperimental2010a]
