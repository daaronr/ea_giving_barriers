...
*Note 1 Jun 2021:** The discussion of Citr is now mainly  outdated, as there is now citation support within Rstudio, at least in the visual mode. Thus I put it in a fold below. This will be updated soon with a guide to  adding references with the built-in citation support.

```


Citr package notes (somewhat obsolete; to be updated)
...
-   Note that `[(at symbol) reference]` gives a different format than `(at symbol) reference`
    (see below test).
