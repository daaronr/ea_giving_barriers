...
**\@ref(present-puzzle): [Presenting the puzzle and challenge: Our ineffective giving](#present-puzzle)** 
...
**\@ref(substitution): [Are charities in competition? Is the ineffective giving reducing effective giving? Ask people to give to EA charity 'instead'?](#substitution)**
...
**\@ref(barriers-intro): [Explaining the puzzle: Barriers to EA giving and potential responses, evidence](#barriers-intro)** 
...
**\@ref(aware-distance): [Barriers: Awareness, consideration, and distance](#aware-distance)**
...
**\@ref(social): [Barriers: Signaling and social pressures/social identity](#social)**
...
**\@ref(eval-aversion): [Barriers: Aversion/obstacles to doing (using) evaluations; effect of analytical information on generosity](#eval-aversion)**
 
**\@ref(factual): [Barriers: Persistent and systematic incorrect empirical beliefs](#factual)**

 
**\@ref(quant-biases): [Barriers: Quantitative biases](#quant-biases)**

**\@ref(inertia): [Barriers: Inertia and systemic/institutional](#inertia)**

**\@ref(tools): [Tools for motivating EA giving](#tools)**

**\@ref(conclusion-agenda): [Conclusion; a research agenda](#conclusion-agenda)**
...
In considering the evidence for these claims, we generally consider one paper or project at a time (or a specific piece of independent evidence from this paper). However, we are still thinking about the best narrative approach to presenting evidence from multiple papers/projects/analyses.  
