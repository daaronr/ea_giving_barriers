...
# BARRIERS: DEFINITION & EVIDENCE {.unnumbered}

```{block2,  type='note'}

See the ['structure of each barriers section'](#structure-barriers) presented in the introduction, as well as  the ['consideration of eavh paper'](#paper-structure).
```
