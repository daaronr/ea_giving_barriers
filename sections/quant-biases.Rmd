...
<!-- this comment means nothing, just testing --> 

Recapping the discussion from the [Conceptual breakdown of 'barriers'](#barriers-concept) section.
...
@baron2011heuristics discuss how the IVE could pose a problem for effective altruism, suggesting two reasons that this could be considered a bias.\*
<div class="marginnote">
\* At least narrowly speaking, this could be seen as a 'bias', not only from the utilitarian perspective, but more generally. Presumably, no moral theory would hold that the moral status of an individual, or one's obligation to them should depend on how that individual is *described*.  (Thanks to Jason Schukraft for this point).
</div>

Firstly, they suggest that when altruism is increased for identified victims, this could result in less altruism for those who are not identified,$^{(?)}$
