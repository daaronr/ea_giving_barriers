...
\
Previous models from Economics typically consider an individual maximizing her utility, including the utility she gets from her donations, directly or indirectly, quantified and formalized in terms of, e.g.,
...
-  "Warm glow": the amount the donor herself has sacrificed (in some depictions, *even if it does no good at all, or completely crowds out others' donations!* \@andreoniImpureAltruismDonations1990, as interpreted by@toninDisentanglingSourcesProsocially2010 and others),

-   the "Impact" a donor's donation has on outcomes [@duncanTheoryImpactPhilanthropy2004] (*not* taking into account the effect of her donation on other donors) or particular identified beneficiaries, [@atkinsonGivingOverseasPublic2009] and
...
::: {.marginnote}
Scharf et al [ref] consider the intertemporal elasticity of a 'warm glow' component.
:::
...
**However, under reasonable assumptions we can *sign* this bias, and thus estimate a lower bound on substitution.**
...
$\rightarrow$ non-disaster giving pre-poned (!), esp. for disaster/intl donors; "halo effect?" Estimates: +.537 log donations to DEC-13, se .032; -0.008 log donations to 'other charities', se 0.017 $\rightarrow$ Reject 'full crowd-out', tight zero LR crowdout
