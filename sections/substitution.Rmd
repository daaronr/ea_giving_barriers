...
But this raises a more difficult question: Is the causality...
...
::: {.marginnote}
\* I discussed this in the previous section; I intend to integrate these discussions to avoid repetition. (To do.)
:::
...
-   "Warm glow": the amount the donor herself has sacrificed (in some depictions, *even if it does no good at all, or completely crowds out others' donations!* \@andreoniImpureAltruismDonations1990, as interpreted [by\@toninDisentanglingSourcesProsocially2010](mailto:by@toninDisentanglingSourcesProsocially2010){.email} and others),
...
*Limitations:* Specific CAF population; disaster-specific; time-series variation issues (6 disasters=lumpy?)
