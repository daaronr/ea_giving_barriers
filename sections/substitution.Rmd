...
Prices/ external changes shift each, but we can’t "force you to voluntarily give" (Also, "Prices" unclear in this context; see giving models; and prices rarely vary exogenously)

If we *could* shift the 'meaningful giving' \(\rightarrow\) we could use theory of Conditional Demand (Pollak) \(\rightarrow\) "expenditure substitution" (Reinstein, ’11). Still, the sign of these effects are straightforward only under very restrictive conditions
