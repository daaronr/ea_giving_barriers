...
author: "David Reinstein, Nick Fitz, Ari Kagan, Janek Kretschmer, Luke Arundel and others. Comments and contributions from Jason Schukraft, Michael Aird, Robin Bergh, Michel Justen and others"
...
bibliography: ["reinstein_bibtex.bib", "references.bib", "sections/references.bib"] #covering all bases here ... should really sort it out some day
...
<!-- NOTE: you now should build this through running `main.R` in the root directory -->
...
Margin notes take the place of footnotes, with asterisks connecting the relevant material.\*
