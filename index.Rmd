...
author: "Dr. David Reinstein, Nick Fitz, Ari Kagan, Janek Kretschmer, Luke Arundel and others"
...
pacman::p_load("bookdown, rmarkdown, knitr, broom, codebook, data.table, dataMaid, dplyr, glue, gtools, here, janitor, lubridate, magrittr, pacman, pastecs, purrr, readr, summarytools, tidyr, tidyverse, base, grid, huxtable, rlang, stats, tibble, pryr, revealjs, renv",
               install=FALSE)
```
...
*Why should 'Effective Altruists' and those interested in long-term global priorities care about the effective/ineffective giving behavior of 'typical' individuals?* Nnotes for Global Priorities Institute presentation (unfold)
