...
bibliography: ["support/reinstein_bibtex.bib", "support/reinstein_references.bib", "packages.bib"] #this first one should be included in the citr settings, second comes from Zotero-dropbox sync, and it's re-downloaded below
