...
![kanban_ea Lit](picsfigs/kanban_ea_Lit.png)

\clearpage


A glimpse of our preliminary paper outline

![paper outline 1](picsfigs/paper_outline_1.png)

![paper_outline_2](picsfigs/paper_outline_2.png)
...
![previous surveys](picsfigs/prev_surveys.png)
...
![barrier template](picsfigs/barrier_template.png)
...
![writeup1](picsfigs/writeup1.png)

\clearpage


![writeup_2](picsfigs/writeup_2.png)
...
How have EA orgs been brought together ...e sp at unis

- Effective thesis project
- EA hub -- add a button here?
- Facebook group

## Conversation with David Janku, Effective thesis project

DR Ideas:

- Effective thesis can link to innovationsinfundraising.org and some of the resources and 'tools' --> projects

Considering how the website works. As a student who opens it and tries to explore it. It was not very clear.

Re-position it more as 'here are some open and interesting questions'

I suggested a list/recognition of coaches... some sort of register of who/where is interested in supervising 'EA PHd's

I will get back to him on who/how to reach out to universities

He advises me to get in touch with people in the EA community focused on charitable giving

Feedback on Effective Thesis project at EA Global

He will connect me with the academic session people at EA Global

Planning to set up a specific page on Effective Thesis website ... dedicated to building research skills; best online courses on methods, writing, etc
