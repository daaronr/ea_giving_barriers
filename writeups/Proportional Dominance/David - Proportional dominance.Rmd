...
Drop in the bucket; mechanisms include "futility thinking" (Unger?),
psychosocial numbing, quantitative confusion/innumeracy
...
manipulations only[^2]; standard student subject pools, small samples.
...
[^2]: They do reverse order of presentations for half the participants.
