...
#### [@caviola2020many] (Hypothetical/intentional experiments; Information treatments, debunking/debiasing) {#caviola}^[CONSIDER: This paper/result may not inform 'evaluation aversion' should we move it to another section or subsection?
]
...
*Study 2: Similar to Study 1, but for preventing HIV infections*^[The third study revolves around the addition of overhead information, in with what might be seen as a fairly negative presentation. I do not discuss it here
]
